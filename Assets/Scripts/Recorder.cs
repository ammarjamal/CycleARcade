...
public class Recorder : MonoBehaviour
{
  /*  GameObjectRecorder _recorder;
    ...
    [SerializeField] string _saveFolderLocation = "Assets/Recordings/";
 
    [SerializeField] string _clipName;
    [SerializeField] float _frameRate = 15f;
 
    [Header("Key Bindings")] 
    [SerializeField] string _startRecKey = "r";
    [SerializeField] string _stopRecKey = "t";
    ...
    void Start()
    {
        ...
        _recorder.BindComponentsOfType<Transform>(gameObject, recursive);
        _recorder.BindComponentsOfType<WheelCollider>(gameObject, recursive);
        _recorder.BindComponentsOfType<MeshRenderer>(gameObject, recursive);
        //_recorder.BindComponentsOfType<BoxCollider>(gameObject, recursive);
        //_recorder.BindComponentsOfType<AudioSource>(gameObject, recursive);



        //_recorder.BindAll(gameObject, true);
